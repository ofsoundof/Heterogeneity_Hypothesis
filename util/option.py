...
# Data specifications
parser.add_argument('--dir_data', default='/scratch_net/ofsoundof/Datasets/classification',
...
# Log specifications
parser.add_argument('--dir_save', default='/scratch_net/ofsoundof/logs_iccv19_classification',
...
parser.add_argument('--regime', type=str, default='large',
                    choices=['x_200mf', 'x_400mf', 'x_600mf', 'x_800mf', 'x_4gf', 'x_8gf',
                             'y_200mf', 'y_400mf', 'y_600mf', 'y_800mf'],
